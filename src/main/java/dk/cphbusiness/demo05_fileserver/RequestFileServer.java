...
//            }
    ...
    public void startConnection( int port )
    {
        try ( ServerSocket serverSocket = new ServerSocket( port ) ) {
            ...
            String response = this.getFile( resource );

//            this.out.println( response );
//            System.out.println( resource );
            
            /* TODO: This will wrap the response into a http response             //---------------Done
    ...
    {
        resource = this.reformatResource( resource ); // remove leading / and add .html if not present
...
//            String content = Files.readString(path, StandardCharsets.UTF_8);
    ...
    { // public because it is used in extensions of the enclosing class
        ...
        {
            return "requestLine='" + this.requestLine + '\'' +
